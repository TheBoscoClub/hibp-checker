...
- Tags: `ghcr.io/greogory/hibp-checker:2.3.1`, `ghcr.io/greogory/hibp-checker:latest`
- Includes: Dashboard, Flask, all v2.3.1 features
...
3. **Push the images:**
   ...
   # Push v2.3.1 tag
   docker push ghcr.io/greogory/hibp-checker:2.3.1
...
# Rebuild
docker build -t ghcr.io/greogory/hibp-checker:2.3.1 \
...
```bash
# Pull the image
docker pull ghcr.io/greogory/hibp-checker:2.3.1

# Check it works
docker run --rm ghcr.io/greogory/hibp-checker:2.3.1 python3 --version

# Test dashboard
docker run --rm -p 5000:5000 \
  -v $(pwd)/reports:/app/reports:ro \
  ghcr.io/greogory/hibp-checker:2.3.1 \
...
docker buildx build \
  ...
  -t ghcr.io/greogory/hibp-checker:2.3.1 \
  -t ghcr.io/greogory/hibp-checker:latest \
  --push \
  .
```
...
3. Push both tags (2.3.1 and latest)
