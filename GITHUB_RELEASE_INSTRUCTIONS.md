# GitHub Release Instructions for v2.3.1
...
### Git Commits & Tags
- ✅ Release commit: `83e0276` - "Release v2.3.1 - Web Dashboard"
- ✅ Annotated tag: `v2.3.1` with full release notes
- ✅ 18 files changed, 2,050+ lines added

### Release Archives
- ✅ `hibp-checker-v2.3.1.tar.gz` (117 KB) - Linux/macOS archive
- ✅ `hibp-checker-v2.3.1.zip` (142 KB) - Windows archive
- ✅ `hibp-checker-v2.3.1.sha256` - Checksums for verification

### Checksums (SHA256)
```
26e21ec4372714b596a9086eba9d9e067e1400176e0942ceafc0832938160985  hibp-checker-v2.3.1.tar.gz
ee30bf4f5310dbaa424694cc337058abfc519026d54046fc134a4826e89474ca  hibp-checker-v2.3.1.zip
```
...
4. Fill in the release form:
   ...
   **Tag version:** `v2.3.1` (select from dropdown)

   **Release title:** `v2.3.1 - Web Dashboard`

   **Description:** Use the content from `RELEASE_NOTES_v2.3.1.md`

5. Attach the release files:
   - Upload `hibp-checker-v2.3.1.tar.gz`
   - Upload `hibp-checker-v2.3.1.zip`
   - Upload `hibp-checker-v2.3.1.sha256`
...
gh release create v2.3.1 \
  --title "v2.3.1 - Web Dashboard" \
  --notes-file RELEASE_NOTES_v2.3.1.md \
  hibp-checker-v2.3.1.tar.gz \
  hibp-checker-v2.3.1.zip \
  hibp-checker-v2.3.1.sha256
```
...
Use the content from `RELEASE_NOTES_v2.3.1.md` as the release description.

### For Social Media / Announcements

```
🎉 HIBP Checker v2.3.1 is here!
